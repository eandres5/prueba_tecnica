...
public class ClientesExceptionHandler {
    ...
    private HttpStatus determineHttpStatus(final Exception ex) {
        return (ex instanceof ClientesException || ex instanceof HttpRequestMethodNotSupportedException
    ...
    private String determineMessage(final Exception ex) {
        if (ex instanceof ClientesException || ex instanceof HttpRequestMethodNotSupportedException) {
